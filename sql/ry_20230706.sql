drop table if exists home_clothing;
...
(
    ...
    season      tinyint(4) default 0 comment '季节:[1:春,2:夏,3:秋,4:冬]',
    status      tinyint(4) default 0 comment '状态:[0:可穿,1不可穿]',
    deleted     tinyint(4) default 0 comment '删除标志:[0:未删,1:已删]',
    created_at  datetime NOT NULL DEFAULT CURRENT_TIMESTAMP comment '创建时间',
    deleted_at  datetime          DEFAULT CURRENT_TIMESTAMP comment '删除时间',
    updated_at  datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP comment '更新时间',
    primary key (id)
) engine=innodb DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC  comment = '衣物穿着表';
